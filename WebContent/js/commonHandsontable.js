var handsontable = (function () {
		  ...
		  directorateId=document.getElementById('directorateId').value;
		  ...
		  if (jsonString!='null' && jsonString.length > 0) {
			...
			var gridCells = function (instance, td, row, col, prop, value, cellProperties) {
				...
				indicatorNumericValidator = function (value, callback) {
					...
					indicatorDecimalValidator = function (value, callback) {
						  setTimeout(function(){
	  		    ...
	  		    cells: function (row, col, prop) {
		        	...
		        	if (col === 3) {
			        		...
			        		if(typeof ischaracter != 'undefined' && ischaracter=='Y'){
			        			...
			        			if(directorateId==7 && isDecimalIndicator(indicatorName))
			        				this.validator=indicatorDecimalValidator;
			        			else
