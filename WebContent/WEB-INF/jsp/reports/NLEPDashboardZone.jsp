...
<script type="text/javascript">
  ...
  return function(table, name) {
    ...
    $("#districtTable").find('tr:first').find('th').css("background", "#00b2ff");
...
$("#districtTable").find('tr:first').find('th').css("background", "#D4D4D4");
...
<script type="text/javascript">
  ...
  return function(table, name) {
    ...
    $("#dashBoardTableId").find('tr:first').find('th').css("background", "#00b2ff");
    var dashboardType=$("#dashboardTypeId").val();
    var monthTemp= $('#month').val();
    var year= $('#year').val();
    var frequency= $('#indFrequency').val();
...
$("#dashBoardTableId").find('tr:first').find('th').css("background", "#D4D4D4");
window.location.href = uri + base64(format(template, ctx))
  }
})()
</script>
...
<div style="height:21px;background: rgb(135, 206, 250);font-size:12px;font-family:Tahoma">
<label style="text-shadow: none;font-weight: bold;line-height:22px;color:#4E4B4B;font-size:12px;font-family:Tahoma"><spring:message code="shdrc_directorate_drilldown_district"/></label><label id="districtLable" style="color:#4E4B4B;font-weight: bold;font-size:12px;font-family:Tahoma"></label>
