...
<html>
	...
	<body onload="onLoad();">
		...
		<table>
			<tr>
				<td class="searchCriteria"><spring:message code="label_searchcriteria_region_corporation"/></td>	
				<td class="searchCriteria" style="padding-left:5px;">	
					<select id="regionName" class="reportDropDown" name="regionName">
			...
			<div style="width:99.3%;">
				...
				<div id="msgTopLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone7_1"/></b><br><br><br><br><br>
				...
				<div id="msgTopRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone7_2"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
			...
			<div style="width:99.3%;">
				...
				<div id="msgBottomLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone7_3"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
				...
				<div id="msgBottomRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone7_6"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
	...
	var analysisReportName1 = "Details of Deaths";
	var analysisReportName2 = "Details of Vital Events";
	var analysisReportName3 = "Details of Water Analysis";
	var analysisReportName4 = "Details of Water Supply";
	...
	function changeYearMonth(){
		...
		var selectedRegion = document.getElementById('regionName');
		if(selectedRegion!='undefined'){
			var regionName = selectedRegion.options[selectedRegion.selectedIndex].text;
		}
		var directorateId = document.getElementById("directorateId").value;
		$.ajax({
			type:"POST",
			url:'maAnalysisZoneSearchChange.do',
			'data':{
				selectedYear:selectedYear,monthName:monthName,directorateId:directorateId,regionName:regionName
			},
