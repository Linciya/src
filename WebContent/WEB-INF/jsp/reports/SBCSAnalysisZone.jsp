...
<html>
	<head>
		...
		<title>SBCS Analysis Zone</title>
		...
		<table>
			...
			<div style="width:99.3%;">
				...
				<div id="msgTopLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone13_1"/></b><br><br><br><br><br>
				...
				<div id="msgTopRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone13_2"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
			...
			<div style="width:99.3%;">
				...
				<div id="msgBottomLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone13_3"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
				...
				<div id="msgBottomRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone13_6"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
	...
	var analysisReportName1 = "Details of Eye Donation";
	var analysisReportName2 = "Details of Other Eye Diseases Yearly";
	var analysisReportName3 = "Details of Performance of Cataract Surgery - Govt Sector";
	var analysisReportName4 = "Details of Performance of Cataract Surgery - NGO Sector";
	...
	function chartsRenderOnLoad(){
		...
		if(analysisZoneReport2Data!=null && analysisZoneReport2Data.length>0){
			...
			StaticChart(secondChart,normalChartTopRightProperties,analysisReportName2,analysisZoneReport2Data,"Indicator Value","Disease");
		}
		else{
	...
	function changeChartTopRight(){	
		...
		if(analysisZoneReport2Data!=null && analysisZoneReport2Data.length>0){
			document.getElementById("msgTopRight").style.display="none";
			StaticChart(chartType,normalChartTopRightProperties,analysisReportName2,analysisZoneReport2Data,"Indicator Value","Disease");
		}
		else{
			document.getElementById("normalChartsTopRight").style.display="none";
			document.getElementById("msgTopRight").style.display="block";
	...
	function changeYearMonth(){
		...
		$.ajax({
			type:"POST",
			url:'sbcsAnalysisZoneSearchChange.do',
			'data':{
