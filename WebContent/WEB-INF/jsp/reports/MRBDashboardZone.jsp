...
<c:forEach var="frncy" items="${indFrncy}">
...
<ul class="tabs-nav">
    <li class=""><a href="#tab-1" rel="nofollow" style="font-size: 12px;height: 30px;line-height: 32px;"><spring:message code="shdrc_directorate_dashboard_tab_Yearly"/></a>
    </li>
</ul>
...
<label style="text-shadow: none;font-weight: bold;line-height:22px;color:#4E4B4B"><spring:message code="shdrc_directorate_drilldown_district"/></label><label id="districtLable" style="color:#4E4B4B;font-weight: bold;"></label>
			 ...
			 dataType: 'text',
	 		 ...
	 		 success: function(result){ 	
	 			    ...
	 			    if(Object.keys(inddata).length === 0){
	 			    	alert('No district data available for '+selectedIndicator+' Indicator');
	 			    	return;
	 			    }
	 			   else{
	 				  $("#districtTable").show();
	 					 ...
	 					 for(var i in inddata) {	 						
	 						if(inddata[i][2]==='Central'){	 							
	 							...
	 							if(rowCountOfDistTable<centralLevel){
	 								 rowCountOfDistTable++;
	 								 $("#districtTableTbody").append('<tr id="row'+rowCountOfDistTable+'"><td id="'+rowCountOfDistTable+'_1_name" class="firstColumnName" onclick="interFace(this.innerHTML);">'+inddata[i][0]+'</td><td id="'+rowCountOfDistTable+'_1_value">'+inddata[i][1]+'</td><td id="'+rowCountOfDistTable+'_2_name" class="secondColumnName" onclick="interFace(this.innerHTML);"></td><td id="'+rowCountOfDistTable+'_2_value"></td><td id="'+rowCountOfDistTable+'_3_name" class="thirdColumnName" onclick="interFace(this.innerHTML);"></td><td id="'+rowCountOfDistTable+'_3_value"></td><td id="'+rowCountOfDistTable+'_4_name" class="fourthColumnName" onclick="interFace(this.innerHTML);"></td><td id="'+rowCountOfDistTable+'_4_value"></td></tr>');								
	 							}else{	 
	 						...
	 						if(inddata[i][2]==='West'){	
                                ...
                                if(rowCountOfDistTable<westLevel){
                                	 rowCountOfDistTable=rowCountOfDistTable+1;
 	 								 $("#districtTableTbody").append('<tr id="row'+rowCountOfDistTable+'"><td id="'+rowCountOfDistTable+'_1_name" class="firstColumnName" onclick="interFace(this.innerHTML);"></td><td id="'+rowCountOfDistTable+'_1_value"></td><td id="'+rowCountOfDistTable+'_2_name" class="secondColumnName" onclick="interFace(this.innerHTML);">'+inddata[i][0]+'</td><td id="'+rowCountOfDistTable+'_2_value">'+inddata[i][1]+'</td><td id="'+rowCountOfDistTable+'_3_name" class="thirdColumnName" onclick="interFace(this.innerHTML);"></td><td id="'+rowCountOfDistTable+'_3_value"></td><td id="'+rowCountOfDistTable+'_4_name" class="fourthColumnName" onclick="interFace(this.innerHTML);"></td><td id="'+rowCountOfDistTable+'_4_value"></td></tr>');
	 						...
	 						if(inddata[i][2]==='South'){	 							
                                 ...
                                 if(rowCountOfDistTable<southLevel){
                                	 rowCountOfDistTable=rowCountOfDistTable+1;
	 								 $("#districtTableTbody").append('<tr id="row'+rowCountOfDistTable+'"><td id="'+rowCountOfDistTable+'_1_name" class="firstColumnName" onclick="interFace(this.innerHTML);"></td><td id="'+rowCountOfDistTable+'_1_value"></td><td id="'+rowCountOfDistTable+'_2_name" class="secondColumnName" onclick="interFace(this.innerHTML);"></td><td id="'+rowCountOfDistTable+'_2_value"></td><td id="'+rowCountOfDistTable+'_3_name" class="thirdColumnName" onclick="interFace(this.innerHTML);">'+inddata[i][0]+'</td><td id="'+rowCountOfDistTable+'_3_value">'+inddata[i][1]+'</td><td id="'+rowCountOfDistTable+'_4_name" class="fourthColumnName" onclick="interFace(this.innerHTML);"></td><td id="'+rowCountOfDistTable+'_4_value"></td></tr>');
	 						...
	 						if(inddata[i][2]==='North'){	 							
								...
								if(rowCountOfDistTable<northLevel){
									 rowCountOfDistTable=rowCountOfDistTable+1;
	 								 $("#districtTableTbody").append('<tr id="row'+rowCountOfDistTable+'"><td id="'+rowCountOfDistTable+'_1_name" class="firstColumnName" onclick="interFace(this.innerHTML);"></td><td id="'+rowCountOfDistTable+'_1_value"></td><td id="'+rowCountOfDistTable+'_2_name" class="secondColumnName" onclick="interFace(this.innerHTML);"></td><td id="'+rowCountOfDistTable+'_2_value"></td><td id="'+rowCountOfDistTable+'_3_name" class="thirdColumnName" onclick="interFace(this.innerHTML);"></td><td id="'+rowCountOfDistTable+'_3_value"></td><td id="'+rowCountOfDistTable+'_4_name" class="fourthColumnName" onclick="interFace(this.innerHTML);">'+inddata[i][0]+'</td><td id="'+rowCountOfDistTable+'_4_value">'+inddata[i][1]+'</td></tr>');
