...
<title>DPH Indicator Zone</title>
...
<script type="text/javascript">
          ...
          /*   var ctx = {worksheet: name || 'Worksheet', table: table.innnertable}
