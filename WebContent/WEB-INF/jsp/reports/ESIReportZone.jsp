		...
		<input id="directorateId"  type="hidden" name="directorateId" value="<%= request.getAttribute("directorateId") %>">
	 	<div class="zonesMainDiv" style="margin-left: -9px;">		
					...
					<tr>
						...
						<td class="searchCriteria" style="padding-left:5px;">
							<select id="reportName" name="reportName" class="dropDown">
								<option value="<spring:message code="shdrc_report_zone21_1"/>"><spring:message code="shdrc_report_zone21_1"/></option>
								<option value="<spring:message code="shdrc_report_zone21_2"/>"><spring:message code="shdrc_report_zone21_2"/></option>
								<option value="<spring:message code="shdrc_report_zone21_3"/>"><spring:message code="shdrc_report_zone21_3"/></option>
								<option value="<spring:message code="shdrc_report_zone21_4"/>"><spring:message code="shdrc_report_zone21_4"/></option>
							</select> 
						</td>
			...
			function changeYearMonth(){
				...
				$.ajax({
					type:"POST",
					url:'esiReportZoneSearchChange.do',
					'data':{
