...
<title>NRHM Indicator Zone</title>
		...
		<div style="width:99.5%;">
			<div id="InstDiv" align="center" style="width:99.5%;height:225px;float:left;margin-top:4px;margin-bottom:4px;border:0.1px solid black;box-shadow: 0 0 1em olive;border-top-left-radius: 10px 10px;border-top-right-radius: 10px 10px;">		
				<div style="background:#e1eaea;width:100%;height: 25px;border-top-left-radius: 10px 10px;border-top-right-radius: 10px 10px;">
					...
					<input type="text" id="SelectedDist" style="background: none;border:none;text-align:left;margin-top: -1px;" value=""/>
				</div>
...
$.ajax({
		...
		success: function(result){
			...
			for(var i=0;i<generalCategoryList.length;i++){
				inserRow +='<ul class="nav nav-tabs" role="tablist" style="height:40px;list-style-type: none;margin: 0;padding: 0;overflow: hidden;border: none;"><li  role="presentation" style="height:40px;text-align:left;width:100px;background: #ffffcc;border:1px solid #0076a3;border-top-left-radius: 5px 5px;border-top-right-radius: 5px 5px;float: left;"><a href="#" onclick=tabChange(this) role="tab" data-toggle="tab" style="margin-left:-1px;margin-top:-1px;word-wrap: break-word;width:100px;height:40px;display: block;color: black;text-align: center;text-decoration: none;transition: 0.5s;font-size: 10px;text-align: center;float:left;">'+generalCategoryList[i]+'</a></li></ul>';       
			}
