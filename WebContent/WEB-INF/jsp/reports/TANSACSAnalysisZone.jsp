...
<html>
	<head>
		...
		<title>TANSACS Analysis Zone</title>
		...
		<table>
			...
			<div style="width:99.3%;">
				...
				<div id="msgTopLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone4_1"/></b><br><br><br><br><br>
				...
				<div id="msgTopRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone4_2"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
			...
			<div style="width:99.3%;">
				...
				<div id="msgBottomLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone4_3"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
				...
				<div id="msgBottomRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone4_6"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
	...
	var analysisReportName1 = "TANSACS - Blood Bags Comparison";
	var analysisReportName2 = "TANSACS - Test Kits Comparison";
	var analysisReportName3 = "TANSACS - No. of Blood units collected";
	var analysisReportName4 = "TANSACS - STI Comparison";
	...
	function changeYearMonth(){
		...
		$.ajax({
			type:"POST",
			url:'tansacsAnalysisZoneSearchChange.do',
			'data':{
