...
<title>NLEP Analysis Zone</title>
	...
	<table>
		...
		<div style="width:99.3%;">
			...
			<div id="msgTopLeft" style="padding-top:50px;">
				<p><b><spring:message code="shdrc_analysis_zone19_1"/></b><br><br><br><br><br>
			...
			<div id="msgTopRight" style="padding-top:50px;">
				<p><b><spring:message code="shdrc_analysis_zone19_2"/></b><br><br><br><br><br>
				This Report has no data for the selected Month and Year </p>
			</div>
			</div>
		</div>
		...
		<div style="width:99.3%;">
			...
			<div id="msgBottomLeft" style="padding-top:50px;">
				<p><b><spring:message code="shdrc_analysis_zone19_3"/></b><br><br><br><br><br>
				This Report has no data for the selected Month and Year </p>
			</div>
			</div>
			...
			<div id="msgBottomRight" style="padding-top:50px;">
				<p><b><spring:message code="shdrc_analysis_zone19_6"/></b><br><br><br><br><br>
				This Report has no data for the selected Month and Year </p>
			</div>
			</div>
		</div>
...
var analysisReportName1 = "Top 10 - New Leprosy Cases  - Districtwise";
var analysisReportName2 = "Analysis - Female Rate";
var analysisReportName3 = "Analysis - MB Rate";
var analysisReportName4 = "Analysis - Child Rate";
...
var analysisZoneReport3Data3 = <%= request.getAttribute("analysisZoneReport3Data3") %>;
...
function chartsRenderOnLoad(){
	...
	if((analysisZoneReport2Data1!=null && analysisZoneReport2Data1.length>0) || (analysisZoneReport2Data2!=null && analysisZoneReport2Data2.length>0) || (analysisZoneReport2Data3!=null && analysisZoneReport2Data3.length>0)){
		...
		combinationCharts(secondChart,normalChartTopRightProperties,analysisReportName2,analysisZoneReport2Data1,analysisZoneReport2Data2,analysisZoneReport2Data3,"Month");
	}
	else{
	...
	if((analysisZoneReport3Data1!=null && analysisZoneReport3Data1.length>0) || (analysisZoneReport3Data2!=null && analysisZoneReport3Data2.length>0) || (analysisZoneReport3Data3!=null && analysisZoneReport3Data3.length>0)){
		...
		StaticMS3DataChart(thirdChart,normalChartBottomLeftProperties,analysisReportName3,analysisZoneReport3Data1,analysisZoneReport3Data2,analysisZoneReport3Data3,"Month");
	}
	else{
	...
	if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
		...
		StaticChart(fourthChart,multiSeriesChartProperties,analysisReportName4,analysisZoneReport4Data,"Indicator Value","Institution");
	}
	else{
...
function changeChartTopRight(){	
	...
	if((analysisZoneReport2Data1!=null && analysisZoneReport2Data1.length>0) || (analysisZoneReport2Data2!=null && analysisZoneReport2Data2.length>0) || (analysisZoneReport2Data3!=null && analysisZoneReport2Data3.length>0)){
		document.getElementById("msgTopRight").style.display="none";
		combinationCharts(chartType,normalChartTopRightProperties,analysisReportName2,analysisZoneReport2Data1,analysisZoneReport2Data2,analysisZoneReport2Data3,"Month");
	}
	else{
		document.getElementById("normalChartsTopRight").style.display="none";
		document.getElementById("msgTopRight").style.display="block";
...
function changeChartBottomLeft(){
	...
	if((analysisZoneReport3Data1!=null && analysisZoneReport3Data1.length>0) || (analysisZoneReport3Data2!=null && analysisZoneReport3Data2.length>0) || (analysisZoneReport3Data3!=null && analysisZoneReport3Data3.length>0)){
		document.getElementById("msgBottomLeft").style.display="none";
		StaticMS3DataChart(ChartType,normalChartBottomLeftProperties,analysisReportName3,analysisZoneReport3Data1,analysisZoneReport3Data2,analysisZoneReport3Data3,"Month");
	}
	else{
		document.getElementById("normalChartsBottomLeft").style.display="none";
		document.getElementById("msgBottomLeft").style.display="block";
...
function changeChartBottomRight(){	
	...
	if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
		document.getElementById("msgBottomRight").style.display="none";
		StaticChart(chartType,multiSeriesChartProperties,analysisReportName4,analysisZoneReport4Data,"Indicator Value","Institution");
	}
	else{
		document.getElementById("multiSeriesChartsBottomRight").style.display="none";
		document.getElementById("msgBottomRight").style.display="block";
...
function changeYearMonth(){
	...
	$.ajax({
		type:"POST",
		url:'nlepAnalysisZoneSearchChange.do',
		'data':{
		 ...
		 success: function(result){
			 	...
			 	analysisZoneReport3Data3=data.analysisZoneReport3Data3;
