...
<html>
	<head>
		...
		<title>CMCHIS Analysis Zone</title>
		...
		<table>
			...
			<div style="width:99.3%;">
				...
				<div id="msgTopLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone17_1"/></b><br><br><br><br><br>
				...
				<div id="msgTopRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone17_2"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
			...
			<div style="width:99.3%;">
				...
				<div id="msgBottomLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone17_3"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
				...
				<div id="normalChartsBottomRight" >
					<p style="margin-top:30px;"><b><spring:message code="shdrc_analysis_zone17_6"/></b>
					<div id="normalChartsBottomRight_Left" align="center" style="width:50%;height:350px;float:left;margin-top:13px;margin-bottom:4px;"></div>
					<div id="normalChartsBottomRight_Right" align="center" style="width:50%;height:350px;float:right;margin-top:10px;margin-bottom:4px;"></div>				
				</div>
				<div id="msgBottomRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone17_6"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
	...
	var normalChartTopRightProperties={"renderAt": 'normalChartsTopRight', "width": '600',"height": '300',"dataFormat": 'json'};
	...
	var normalChartsBottomRight_LeftProperties={"renderAt": 'normalChartsBottomRight_Left', "width": '300',"height": '250',"dataFormat": 'json',"startingAngle": "20","showPercentValues": "0","showPercentInTooltip": "0","enableSmartLabels": "0","enableMultiSlicing": "0","decimals": "1","showLegend": "1","theme": "fint"};
	var normalChartsBottomRight_RightProperties={"renderAt": 'normalChartsBottomRight_Right', "width": '300',"height": '250',"dataFormat": 'json',"startingAngle": "20","showPercentValues": "0","showPercentInTooltip": "0","enableSmartLabels": "0","enableMultiSlicing": "0","decimals": "1","showLegend": "1","theme": "fint"};
	
	var analysisReportName1 = "Trend Analysis - Patient Died";
	var analysisReportName2 = "Trend Analysis - Preauth, Claims, DC Comparison";
	var analysisReportName3 = "Trend Analysis - Preauth (Status_wise Comparison)";
	var analysisReportName4 = "Trend Analysis - Rejection due to want of document";
	...
	function chartsRenderOnLoad(){
		...
		var rejectionFirstSeriesData=[];
		var rejectionSecondSeriesData=[];
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			var indicator=analysisZoneReport4Data[0].seriesName;
			for(i=0;i<analysisZoneReport4Data.length;i++){
				if(analysisZoneReport4Data[i].seriesName!=indicator){
					rejectionFirstSeriesData.push(analysisZoneReport4Data[i]);
				}
				else{
					rejectionSecondSeriesData.push(analysisZoneReport4Data[i]);
				}
			}
		}
		...
		if(analysisZoneReport1Data!=null && analysisZoneReport1Data.length>0){
			...
			StaticChart(firstChart,normalChartTopLeftProperties,analysisReportName1,analysisZoneReport1Data,"Indicator Value","Month");
		}
		else{
		...
		if((analysisZoneReport2Data1!=null && analysisZoneReport2Data1.length>0) || (analysisZoneReport2Data2!=null && analysisZoneReport2Data2.length>0)){
			...
			combinationCharts2Data(secondChart,normalChartTopRightProperties,analysisReportName2,analysisZoneReport2Data1,analysisZoneReport2Data2,"Indicator");
		}
		else{
		...
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			...
			var seriesName1;
			var seriesName2;
			if(rejectionFirstSeriesData!=null && rejectionFirstSeriesData.length>0){
				seriesName1=rejectionFirstSeriesData[0].seriesName;
			}
			else{
				seriesName1="";
			}
			if(rejectionSecondSeriesData!=null && rejectionSecondSeriesData.length>0){
				seriesName2=rejectionSecondSeriesData[0].seriesName;
			}
			else{
				seriesName2="";
			}
			StaticChart(fourthChart,normalChartsBottomRight_LeftProperties,seriesName1,rejectionFirstSeriesData,"Indicator Value","Institution");
			StaticChart(fourthChart,normalChartsBottomRight_RightProperties,seriesName2,rejectionSecondSeriesData,"Indicator Value","Institution");
		}
		else{
	...
	function changeChartTopLeft(){
		...
		if(analysisZoneReport1Data!=null && analysisZoneReport1Data.length>0){
			document.getElementById("msgTopLeft").style.display="none";
			StaticChart(chartType,normalChartTopLeftProperties,analysisReportName1,analysisZoneReport1Data,"Indicator Value","Month");
		}
		else{
			document.getElementById("normalChartsTopLeft").style.display="none";
			document.getElementById("msgTopLeft").style.display="block";
	...
	function changeChartTopRight(){	
		...
		if((analysisZoneReport2Data1!=null && analysisZoneReport2Data1.length>0) || (analysisZoneReport2Data2!=null && analysisZoneReport2Data2.length>0)){
			document.getElementById("msgTopRight").style.display="none";
			combinationCharts2Data(chartType,normalChartTopRightProperties,analysisReportName2,analysisZoneReport2Data1,analysisZoneReport2Data2,"Indicator");
		}
		else{
			document.getElementById("normalChartsTopRight").style.display="none";
			document.getElementById("msgTopRight").style.display="block";
	...
	function changeChartBottomRight(){
		...
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			document.getElementById("msgBottomRight").style.display="none";
			StaticChart(chartType,normalChartsBottomRight_LeftProperties,rejectionFirstSeriesData[0].seriesName,rejectionFirstSeriesData,"Indicator Value","Institution");
			StaticChart(chartType,normalChartsBottomRight_RightProperties,rejectionSecondSeriesData[0].seriesName,rejectionSecondSeriesData,"Indicator Value","Institution");
	...
	function changeYearMonth(){
		...
		$.ajax({
			type:"POST",
			url:'cmchisAnalysisZoneSearchChange.do',
			'data':{
