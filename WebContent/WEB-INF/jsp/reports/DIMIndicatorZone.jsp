...
<title>DIM Indicator Zone</title>
...
function onLoad(){
	...
	if(indPvtInstData === null){
		...
		if(indPvtInstData.length === 0){
			...
			$("#pvtInst").pivot(
					indPvtInstData, {
						rows: ["Institution_Type","Institution","Institution_Spec"],
					    cols: ["GeneralName"],
					    aggregator: $.pivotUtilities.aggregators["Integer Sum"](["Value"]),
					    aggregatorName: "Sum over Sum",
					    rendererName: "Table",
