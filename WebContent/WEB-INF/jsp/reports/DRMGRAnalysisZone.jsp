...
<html>
	<head>
		...
		<title>DRMGR Analysis Zone</title>
		...
		<table>
			...
			<div style="width:99.3%;">
				...
				<div id="msgTopLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone9_1"/></b><br><br><br><br><br>
				...
				<div id="msgTopRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone9_2"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
			...
			<div style="width:99.3%;">
				...
				<div id="msgBottomLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone9_3"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
				...
				<div id="msgBottomRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone9_6"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
	...
	var analysisReportName1 = "Trend of Phd Awarded";
	var analysisReportName2 = "Students Admitted in Top 10 Institutions-Year wise";
	var analysisReportName3 = "Number of Degrees Awarded - Across Medical Colleges";
	var analysisReportName4 = "Comparison of various institutions -Year wise";
	...
	function chartsRenderOnLoad(){
		...
		if(analysisZoneReport1Data!=null && analysisZoneReport1Data.length>0){
			...
			StaticChart(firstChart,normalChartTopLeftProperties,analysisReportName1,analysisZoneReport1Data,"Students Count","Month");
		}
		else{
		...
		if(analysisZoneReport2Data!=null && analysisZoneReport2Data.length>0){
			...
			StaticChart(secondChart,normalChartTopRightProperties,analysisReportName2,analysisZoneReport2Data,"Students Admitted","Institution");
		}
		else{
		...
		if(analysisZoneReport3Data!=null && analysisZoneReport3Data.length>0){
			...
			StaticChart(thirdChart,normalChartBottomLeftProperties,analysisReportName3,analysisZoneReport3Data,"Indicator Value","Institution");
		}
		else{
		...
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			...
			StaticChart(fourthChart,normalChartBottomRightProperties,analysisReportName4,analysisZoneReport4Data,"Indicator Value","Institution");
		}
		else{
	...
	function changeChartTopLeft(){
		...
		if(analysisZoneReport1Data!=null && analysisZoneReport1Data.length>0){
			document.getElementById("msgTopLeft").style.display="none";
			StaticChart(chartType,normalChartTopLeftProperties,analysisReportName1,analysisZoneReport1Data,"Students Count","Month");
		}
		else{
			document.getElementById("normalChartsTopLeft").style.display="none";
			document.getElementById("msgTopLeft").style.display="block";
	...
	function changeChartTopRight(){	
		...
		if(analysisZoneReport2Data!=null && analysisZoneReport2Data.length>0){
			document.getElementById("msgTopRight").style.display="none";
			StaticChart(chartType,normalChartTopRightProperties,analysisReportName2,analysisZoneReport2Data,"Students Admitted","Institution");
		}
		else{
			document.getElementById("normalChartsTopRight").style.display="none";
			document.getElementById("msgTopRight").style.display="block";
	...
	function changeChartBottomLeft(){
		...
		if(analysisZoneReport3Data!=null && analysisZoneReport3Data.length>0){
			document.getElementById("msgBottomLeft").style.display="none";
			StaticChart(ChartType,normalChartBottomLeftProperties,analysisReportName3,analysisZoneReport3Data,"Indicator Value","Institution");
		}
		else{
			document.getElementById("normalChartsBottomLeft").style.display="none";
			document.getElementById("msgBottomLeft").style.display="block";
	...
	function changeChartBottomRight(){
		...
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			document.getElementById("msgBottomRight").style.display="none";
			StaticChart(chartType,normalChartBottomRightProperties,analysisReportName4,analysisZoneReport4Data,"Indicator Value","Institution");
		}
		else{
			document.getElementById("normalChartsBottomRight").style.display="none";
			document.getElementById("msgBottomRight").style.display="block";
	...
	function changeYearMonth(){
		...
		$.ajax({
			type:"POST",
			url:'drmgrAnalysisZoneSearchChange.do',
			'data':{
