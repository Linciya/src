	...
	<body onload ="onLoad();" style="font-family: Tahoma;">
		...
		<div id="searchCriteriaTable" style="border-bottom:solid 0.1px #2B65EC;">
					...
					<tr>
						...
						<td class="searchCriteria" style="padding-left:5px;">
							<select id="reportName" name="reportName" class="dropDown">
								<option value="<spring:message code="shdrc_report_zone18_1"/>"><spring:message code="shdrc_report_zone18_1"/></option>
								<option value="<spring:message code="shdrc_report_zone18_2"/>"><spring:message code="shdrc_report_zone18_2"/></option>
								<option value="<spring:message code="shdrc_report_zone18_3"/>"><spring:message code="shdrc_report_zone18_3"/></option>
							</select> 
						</td>
			...
			function changeYearMonth(){
				...
				$.ajax({
					type:"POST",
					url:'dimReportZoneSearchChange.do',
					'data':{
