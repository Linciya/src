		...
		<input id="directorateId"  type="hidden" name="directorateId" value="<%= request.getAttribute("directorateId") %>">
	 	<div class="zonesMainDiv" style="margin-left: -9px;">		
					...
					<tr>
						...
						<td class="searchCriteria" style="padding-left:5px;">
							<select id="reportName" name="reportName" class="reportDropDown" style="width: 250px;">
								<option value="<spring:message code="shdrc_report_zone14_1"/>"><spring:message code="shdrc_report_zone14_1"/></option>
								<option value="<spring:message code="shdrc_report_zone14_2"/>"><spring:message code="shdrc_report_zone14_2"/></option>
								<option value="<spring:message code="shdrc_report_zone14_3"/>"><spring:message code="shdrc_report_zone14_3"/></option>
								<option value="<spring:message code="shdrc_report_zone14_4"/>"><spring:message code="shdrc_report_zone14_4"/></option>
								<option value="<spring:message code="shdrc_report_zone14_5"/>"><spring:message code="shdrc_report_zone14_5"/></option>
								<option value="<spring:message code="shdrc_report_zone14_6"/>"><spring:message code="shdrc_report_zone14_6"/></option>	
								<option value="<spring:message code="shdrc_report_zone14_7"/>"><spring:message code="shdrc_report_zone14_7"/></option>
							</select> 
						</td>
			...
			function changeYearMonth(){
				...
				$.ajax({
					type:"POST",
					url:'dcaReportZoneSearchChange.do',
					'data':{
			...
			function getRowName(reportName,month,year){
				var rowName;
				if((reportName=="Analysis of sample-Analyst data")){
					rowName=["General Type","General Name"];
				}
				else if((reportName=="Blood Bank and related Licences data") || (reportName=="Details of Manufacturing Licence")
						 || (reportName=="Details of Sales Licences")){
					rowName=["Indicator"];
				}
				else if((reportName=="Number of Inspections Carried Out") || (reportName=="Number of Samples Drawn")){
					rowName=["Block Name"];
				}
				return rowName;
			}
			...
			function getColName(reportName){
				var colName;		
				if((reportName=="Analysis of sample-Analyst data")){
					colName=["Indicator","Year","Month"];
				}
				else if((reportName=="Blood Bank and related Licences data") || (reportName=="Details of Manufacturing Licence")){
					colName=["General Name","General Type"];
				}
				else if((reportName=="Details of Sales Licences")){
					colName=["General Type","General Name"];
				}
				else if((reportName=="Blood Storage Centres")){
					colName=["Year","General Type"];
				}
				else if((reportName=="Number of Inspections Carried Out") || (reportName=="Number of Samples Drawn")){
					colName=["Year","Month"];
				}
