	...
	var selectedMonth=document.getElementById("month");
	 ...
	 var selectedYear=document.getElementById("year");
		...
		if (selectedExportTable != 'undefined') {
		 ...
		 $("#thDistrictId").find('th').css("background-color", "#00b2ff");
		 $("#pvt1").find('tr:first').css("background", "#00b2ff");
		 
		 $("#thDistrictId").find('tr').find('th').css("border", "1px groove black");
			$("#thDistrictId").find('tr').find('th').css("border-collapse", "collapse");
...
table#dashBoardTableId1 thead tr {
    margin: 0px 0px 1px;
    font-size:12px;
    font-family:Tahoma;
}

table#dashBoardTableId1 thead tr th {
    border-bottom: 1px solid #FFFFFF;
     font-size:12px;
    font-family:Tahoma;
}
table#dashBoardTableId1 tr td.indicatorState:HOVER {
	cursor:pointer;
	text-decoration: underline;
}
table#dashBoardTableId1 thead tr th:nth-child(1) {
    text-align: left;
    background: #D4D4D4;
    padding: 13px 9px 8px;
    width: 435px;
...
table#dashBoardTableId1 thead tr th:nth-child(3) {
    text-align: left;
    background: #D4D4D4;
    padding: 13px 9px 8px;
    width: 140px;
...
table#dashBoardTableId1 thead tr th:nth-child(even) {
    text-align: center;
    background: #D4D4D4;
    padding: 0px 9px;
    width: 115px;
...
table#dashBoardTableId1 tbody tr {}

table#dashBoardTableId1 tbody tr:nth-child(odd) {
    background: #F7F7F7;
}

table#dashBoardTableId1 tbody tr:nth-child(even) {
    background: #F0F0F0;
}

table#dashBoardTableId1 tbody tr td:nth-child(1) {
    width: 435px;
}
table#dashBoardTableId1 tbody tr td:nth-child(3) {
    width: 140px;
}

table#dashBoardTableId1 tbody tr td:nth-child(even) {
    width: 115px;
    border-right: #FFFFFF solid 1px;
}

table#dashBoardTableId1 tbody tr td {
    padding: 7px 9px 8px 9px;
    border-bottom: 1px solid #FFFFFF;
}

table#dashBoardTableId1 tbody tr:last-of-type td {
    border-bottom: 0 none;
} */
</style>
<!-- District End  -->
...
<ul class="tabs-nav">    
    ...
    <li class=""><a class="Quarterly" href="#tab-2" rel="nofollow" style="font-size: 12px;"><spring:message code="shdrc_directorate_dashboard_tab_Quarterly"/></a>
    </li>
</ul>
...
<table id="dashBoardTableId" cellpadding="0" cellspacing="0" summary="">
    ...
    <tbody id="dashBoardTableTbodyId1">
    </tbody>
</table>
    </div> 
</div>
...
<input type="hidden" id="tabSearchCriteriaName" class="tabSearchCriteriaName" value="<spring:message code="shdrc_directorate4_dashboard_tab_action_search"/>">
...
$('.tabs-nav a').on('click', function (event) {
	 ...
	 $.ajax({		
			 ...
			 success: function(result){ 
				 ...
				 if(activeTabName==="Monthly Indicator"){				
					 divTempName="dashBoardTableTbodyId";					
				 }if(activeTabName==="Quarterly Indicator"){				
					 divTempName="dashBoardTableTbodyId1";					
				 }			
	 ...
	 $($(this).attr('href')).show();
	 $('table#dashBoardTableId tbody#'+divTempName+' tr td.indicatorState').eq(0).trigger('click');
	});
	$( document ).ready(function() {	
		...
		var tempDataDiv;
		 if($("#initialTabName").val()==="Monthly"){
			 tempDataDiv="dashBoardTableTbodyId";
		 }else{
			 tempDataDiv="dashBoardTableTbodyId1";
		 }
		var inTabName=$("#initialTabName").val();
		$('.tabs-nav li a.'+inTabName).trigger('click');
		$('table#dashBoardTableId tbody#'+tempDataDiv+' tr td.indicatorState').eq(0).trigger('click');
	});
			 ...
			 dataType: 'text',
	 		 ...
	 		 success: function(result){ 	
	 			    ...
	 			    if(Object.keys(inddata).length === 0){
	 			    	...
	 			    	$("#pvt1 table.pvtTable").empty();
	 			    	$("#institutionPreviewContent").show();
	 			    	$("#institutionPreview").show();
	 			    	$('#institutionLable').text("");
	 			    	return;
	 			    }
	 			   else{
	 				  $("#districtTable").show();
