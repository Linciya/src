...
<ul class="tabs-nav">    
    ...
    <li class=""><a class="Monthly" href="#tab-2" rel="nofollow" style="font-size: 12px;"><spring:message code="shdrc_directorate_dashboard_tab_Monthly"/></a>
    </li>
</ul>
...
<div id="dashBoardSecond" class="dashBoardSecond" style="width:50%;height:auto;background:#ffffcc;overflow:auto;margin-left:660px;margin-top:27px;border-color: red;">
...
var repeatCount=0;
$(document).on('click','table#grid-basic tbody tr td.indicatorState',function() {
