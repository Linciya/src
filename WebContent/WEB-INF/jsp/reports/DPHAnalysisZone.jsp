...
<html>
		...
		<table>
			...
			<div style="width:99.3%;">
				...
				<div id="msgTopLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone2_1"/></b><br><br><br><br><br>
				...
				<div id="msgTopRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone2_2"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
			...
			<div style="width:99.3%;">
				...
				<div id="msgBottomLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone2_3"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
				...
				<div id="msgBottomRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone2_6"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
	...
	var analysisReportName1 = "Maternal Death";
	var analysisReportName2 = "Infant Death";
	var analysisReportName3 = "Low Birth Weight Babies";
	var analysisReportName4 = "Postnatal Mothers Given IFA Large Tablets";
	...
	function changeYearMonth(){
		...
		$.ajax({
			type:"POST",
			url:'dphAnalysisZoneSearchChange.do',
			'data':{
