	...
	<body onload ="onLoad();" style="font-family: Tahoma;">
		...
		<div id="searchCriteriaTable" style="border-bottom:solid 0.1px #2B65EC;">
					...
					<tr>
						...
						<td class="searchCriteria" style="padding-left:5px;">
							<select id="reportName" name="reportName" class="dropDown">
								<option value="<spring:message code="shdrc_report_zone2_1"/>"><spring:message code="shdrc_report_zone2_1"/></option>
								<option value="<spring:message code="shdrc_report_zone2_2"/>"><spring:message code="shdrc_report_zone2_2"/></option>
								<option value="<spring:message code="shdrc_report_zone2_3"/>"><spring:message code="shdrc_report_zone2_3"/></option>
								<option value="<spring:message code="shdrc_report_zone2_4"/>"><spring:message code="shdrc_report_zone2_4"/></option>
								<option value="<spring:message code="shdrc_report_zone2_5"/>"><spring:message code="shdrc_report_zone2_5"/></option>
							</select> 
						</td>
			...
			function changeYearMonth(){
				...
				$.ajax({
					type:"POST",
					url:'dphReportZoneSearchChange.do',
					'data':{
