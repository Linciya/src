		...
		<input id="directorateId"  type="hidden" name="directorateId" value="<%= request.getAttribute("directorateId") %>">
	 	<div class="zonesMainDiv" style="margin-left: -9px;">		
					...
					<tr>
						...
						<td class="searchCriteria" style="padding-left:5px;">
							<select id="reportName" name="reportName" class="reportDropDown" style="width: 250px;">
								<option value="<spring:message code="shdrc_report_zone12_1"/>"><spring:message code="shdrc_report_zone12_1"/></option>
								<option value="<spring:message code="shdrc_report_zone12_2"/>"><spring:message code="shdrc_report_zone12_2"/></option>
								<option value="<spring:message code="shdrc_report_zone12_3"/>"><spring:message code="shdrc_report_zone12_3"/></option>
								<option value="<spring:message code="shdrc_report_zone12_4"/>"><spring:message code="shdrc_report_zone12_4"/></option>
								<option value="<spring:message code="shdrc_report_zone12_5"/>"><spring:message code="shdrc_report_zone12_5"/></option>
								<option value="<spring:message code="shdrc_report_zone12_6"/>"><spring:message code="shdrc_report_zone12_6"/></option>	
								<option value="<spring:message code="shdrc_report_zone12_7"/>"><spring:message code="shdrc_report_zone12_7"/></option>
								<option value="<spring:message code="shdrc_report_zone12_8"/>"><spring:message code="shdrc_report_zone12_8"/></option>
							</select> 
						</td>
			...
			function changeYearMonth(){
				...
				$.ajax({
					type:"POST",
					url:'cocReportZoneSearchChange.do',
					'data':{
			...
			function getRowName(reportName,month,year){
				var rowName;
				if((reportName=="Drinking water quality") || (reportName=="UPHC-Treatment Services") || (reportName=="Vector Control Activities")
						|| (reportName=="Regulatory functions")){
					rowName=["Zone"];
				}
				else if(reportName=="Control of Communicable Diseases"){
					rowName=["Zone","Institution Name"];
				}
				else if(reportName=="Performance of Diagnostic Centre"){
					rowName=["General Name","Zone"];
				}
				else if((reportName=="Veterinary Section") || (reportName=="Vital Statistics")){
					rowName=["Indicator"];
				}
				return rowName;
			}
			...
			function getColName(reportName){
				var colName;		
				if((reportName=="Drinking water quality") || (reportName=="UPHC-Treatment Services")){
					colName=["Indicator","General Name"];
				}
				else if((reportName=="Control of Communicable Diseases") || (reportName=="Performance of Diagnostic Centre")){
					colName=["Year","Month","Indicator"];
				}
				else if((reportName=="Veterinary Section") || (reportName=="Vital Statistics")){
					colName=["Zone"];
				}
				else if((reportName=="Regulatory functions") || (reportName=="Vector Control Activities")){
