...
<script type="text/javascript">
  ...
  return function(table, name) {
	...
	if (selectedFrequency != 'undefined') {
		...
		var frequencyNameVal=selectedFrequency.options[selectedFrequency.selectedIndex].value;
	...
	var selectedMonth=document.getElementById("month");
	 ...
	 var selectedYear=document.getElementById("year");
		...
		if (selectedExportTable != 'undefined') {
		 ...
		 $("#pvt1").find('tr:nth-child(2)').find('th').css("background", "#00b2ff");
...
<label style="text-shadow: none;font-weight: bold;line-height:22px;color:#4E4B4B;font-family:Tahoma;font-size: 12px;"><spring:message code="shdrc_directorate_drilldown_district"/></label><label id="districtLable" style="color:#4E4B4B;font-weight: bold;font-family:Tahoma;font-size: 12px;"></label>
</div>
			 ...
			 dataType: 'text',
	 		 ...
	 		 success: function(result){ 	
	 			    ...
	 			    if(Object.keys(inddata).length === 0){
	 			    	if(repeatCount<1){
		 			    	 repeatCount++;
		 			         $('table#grid-basic tbody tr td.indicatorState').eq(1).trigger('click');
		 			      }
	 			    	return;
	 			    }
	 			   else{
