		...
		<input id="directorateId"  type="hidden" name="directorateId" value="<%= request.getAttribute("directorateId") %>">
	 	<div class="zonesMainDiv" style="margin-left: -9px;">		
					...
					<tr>
						...
						<td class="searchCriteria" style="padding-left:5px;">
							<select id="reportName" name="reportName" class="dropDown" style="width:350px;">
								<option value="<spring:message code="shdrc_report_zone13_1"/>"><spring:message code="shdrc_report_zone13_1"/></option>
								<option value="<spring:message code="shdrc_report_zone13_2"/>"><spring:message code="shdrc_report_zone13_2"/></option>
								<option value="<spring:message code="shdrc_report_zone13_3"/>"><spring:message code="shdrc_report_zone13_3"/></option>
								<option value="<spring:message code="shdrc_report_zone13_4"/>"><spring:message code="shdrc_report_zone13_4"/></option>
								<option value="<spring:message code="shdrc_report_zone13_5"/>"><spring:message code="shdrc_report_zone13_5"/></option>
								<option value="<spring:message code="shdrc_report_zone13_6"/>"><spring:message code="shdrc_report_zone13_6"/></option>
								<option value="<spring:message code="shdrc_report_zone13_7"/>"><spring:message code="shdrc_report_zone13_7"/></option>
								<option value="<spring:message code="shdrc_report_zone13_8"/>"><spring:message code="shdrc_report_zone13_8"/></option>
								<option value="<spring:message code="shdrc_report_zone13_9"/>"><spring:message code="shdrc_report_zone13_9"/></option>
								<option value="<spring:message code="shdrc_report_zone13_10"/>"><spring:message code="shdrc_report_zone13_10"/></option>
								<option value="<spring:message code="shdrc_report_zone13_11"/>"><spring:message code="shdrc_report_zone13_11"/></option>
								<option value="<spring:message code="shdrc_report_zone13_12"/>"><spring:message code="shdrc_report_zone13_12"/></option>
								<option value="<spring:message code="shdrc_report_zone13_13"/>"><spring:message code="shdrc_report_zone13_13"/></option>
								<option value="<spring:message code="shdrc_report_zone13_14"/>"><spring:message code="shdrc_report_zone13_14"/></option>
								<option value="<spring:message code="shdrc_report_zone13_15"/>"><spring:message code="shdrc_report_zone13_15"/></option>
								<option value="<spring:message code="shdrc_report_zone13_16"/>"><spring:message code="shdrc_report_zone13_16"/></option>
							</select> 
						</td>
			...
			function changeYearMonth(){
				...
				$.ajax({
					type:"POST",
					url:'sbcsReportZoneSearchChange.do',
					'data':{
			...
			function getRowName(reportName,month,year){
				var rowName;
				if((reportName=="Abstract of Cataract Surgeries performed") || (reportName=="Doctors Performance")){
					rowName=["Institution"];
				}
				else if((reportName=="Eye Donation") || (reportName=="Receipts and Expenditure for the Months-Overall") || (reportName=="School Eye Screening")
						 || (reportName=="Other Eye Disease(Yearly)")){
					rowName=["Indicator"];
				}
				else if((reportName=="Financial Management Report") || (reportName=="Receipts and Expenditure for the Months")){
					rowName=["General Name"];
				}
				else if((reportName=="Liability Performance Report for the Period") || (reportName=="Performance of Cataract Surgery - NGO Sector")){
					rowName=["Name of the NGO"];
				}
				else if(reportName=="Performance of Cataract Surgery - Govt Sector"){
					rowName=["Name of the Hospital"];
				}
				else if(reportName=="Physical Performance Report for the Period"){
					rowName=["Month","Year"];
				}
				else if((reportName=="Cornea Collection During the Year") || (reportName=="Monthwise Performance of Cataract Surgery During Year")
						 || (reportName=="Cataract Performance for the Year") || (reportName=="School Eye Screening(Yearly)")){
					rowName=["State Name"];
				}
				return rowName;
			}
			...
			function getColName(reportName){
				var colName;		
				if((reportName=="Abstract of Cataract Surgeries performed")){
					colName=["Indicator","General Type","General Name"];
				}
				else if((reportName=="Doctors Performance") || (reportName=="Financial Management Report") || (reportName=="Receipts and Expenditure for the Months")
						 || (reportName=="Cornea Collection During the Year") || (reportName=="Monthwise Performance of Cataract Surgery During Year")
						 || (reportName=="Cataract Performance for the Year")){
					colName=["Indicator"];
				}
				else if(reportName=="Eye Donation"){
					colName=["General Name"];
				}
				else if(reportName=="Liability Performance Report for the Period"){
					colName=["Year","Month"];
				}
				else if(reportName=="Performance of Cataract Surgery - Govt Sector"){
					colName=["Year","Month","Indicator"];
				}
				else if(reportName=="Performance of Cataract Surgery - NGO Sector"){
					colName=["Indicator","General Name"];
				}
				else if(reportName=="Physical Performance Report for the Period"){
					colName=["Name of the NGO"];
				}
				else if(reportName=="School Eye Screening(Yearly)"){
