...
<title>NLEP Indicator Zone</title>
...
<div id="searchCriteriaTable" style="border-bottom:solid 0.1px #2B65EC;">
	<table>
		<tr id="filters">
			...
			<td class="searchCriteria" style="padding-left:3px;">
				<input type="text" id="txtFrom" style="width:100px;"/>
			</td>
			...
			<td class="searchCriteria" style="padding-left:3px;">
				<input type="text" id="txtTo" style="width:100px;"/>
			</td>
	...
	<div style="width:99.3%;">
			<div id="StateDiv" align="center" style="width:39%;height:475px;float:left;border:0.1px solid black;box-shadow: 0 0 1em olive;border-top-left-radius: 10px 10px;border-top-right-radius: 10px 10px;">
				...
				<label id="noStateData" style="margin-left: -150px;margin-top: 180px;position: absolute;"><spring:message code="label_shownodata"/></label>
				<div id="pvtState" class="pvtState" style="width:38.5%;height:450px; overflow:scroll;position: absolute;"></div>
			</div>
			
			<div id="DistDiv" align="center" style="width:60%;height:475px;float:right;border:0.1px solid black;box-shadow: 0 0 1em olive;border-top-left-radius: 10px 10px;border-top-right-radius: 10px 10px;">
				...
				<div id="tab-content" style="background:#e1eaea;width:100%;height: 25px;border-top-left-radius: 10px 10px;border-top-right-radius: 10px 10px;">
					...
					<input type="text" id="SelectedIndicatorName" style="background: none;border: none;margin-top: -9px;text-align: center;" value=""/>
				</div>
				<label id="noDistrictData" style="margin-left:-50px; margin-top: 170px;position: absolute;"><spring:message code="label_shownodata"/></label>
				<div id="pvtDist" class="pvtDist" style="width:59%;height:413px; overflow:scroll;position: absolute;"></div>
			</div>
		</div>
</div>
</body>
...
/* var all_tr = $('#pvtDist > #pvtTable tr th.pvtRowLabel'); 
$(document).on("click", "div#pvtDist > #pvtTable tr th.pvtRowLabel", function(e) {
//all_tr.removeClass('selected');
   // $("#pvtDist > #pvtTable tr th.pvtRowLabel").closest('#pvtDist > #pvtTable tr th.pvtRowLabel').addClass('selected'); 
