...
<html>
	<head>
		...
		<title>SHTD Analysis Zone</title>
		...
		<table>
			...
			<div style="width:99.3%;">
				...
				<div id="msgTopLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone11_1"/></b><br><br><br><br><br>
				...
				<div id="msgTopRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone11_2"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
			...
			<div style="width:99.3%;">
				...
				<div id="msgBottomLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone11_3"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
				...
				<div id="msgBottomRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone11_6"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
	...
	var analysisReportName1 = "Man Hour Utilization Target Fixed";
	var analysisReportName2 = "Technical Staff In Position";
	var analysisReportName3 = "Tyre Value in stock at end of the month";
	var analysisReportName4 = "Total ManHour Monthly Wise";
	...
	function chartsRenderOnLoad(){
		...
		if(analysisZoneReport2Data!=null && analysisZoneReport2Data.length>0){
			...
			StaticChart(secondChart,normalChartTopRightProperties,analysisReportName2,analysisZoneReport2Data,"Indicator Value","Month");
		}
		else{
		...
		if(analysisZoneReport3Data!=null && analysisZoneReport3Data.length>0){
			...
			StaticChart(thirdChart,normalChartBottomLeftProperties,analysisReportName3,analysisZoneReport3Data,"Indicator Value","Month");
		}
		else{
		...
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			...
			StaticChart(fourthChart,normalChartBottomRightProperties,analysisReportName4,analysisZoneReport4Data,"Indicator Value","Month");
		}
		else{
	...
	function changeChartTopRight(){	
		...
		if(analysisZoneReport2Data!=null && analysisZoneReport2Data.length>0){
			document.getElementById("msgTopRight").style.display="none";
			StaticChart(chartType,normalChartTopRightProperties,analysisReportName2,analysisZoneReport2Data,"Indicator Value","Month");
		}
		else{
			document.getElementById("normalChartsTopRight").style.display="none";
			document.getElementById("msgTopRight").style.display="block";
	...
	function changeChartBottomLeft(){
		...
		if(analysisZoneReport3Data!=null && analysisZoneReport3Data.length>0){
			document.getElementById("msgBottomLeft").style.display="none";
			StaticChart(ChartType,normalChartBottomLeftProperties,analysisReportName3,analysisZoneReport3Data,"Indicator Value","Month");
		}
		else{
			document.getElementById("normalChartsBottomLeft").style.display="none";
			document.getElementById("msgBottomLeft").style.display="block";
	...
	function changeChartBottomRight(){
		...
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			document.getElementById("msgBottomRight").style.display="none";
			StaticChart(chartType,normalChartBottomRightProperties,analysisReportName4,analysisZoneReport4Data,"Indicator Value","Month");
		}
		else{
			document.getElementById("normalChartsBottomRight").style.display="none";
			document.getElementById("msgBottomRight").style.display="block";
	...
	function changeYearMonth(){
		...
		$.ajax({
			type:"POST",
			url:'shtdAnalysisZoneSearchChange.do',
			'data':{
