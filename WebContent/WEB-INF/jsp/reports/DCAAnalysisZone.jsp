...
<html>
			...
			<table>
				...
				<div style="width:99.3%;">
					...
					<div id="msgTopLeft" style="padding-top:50px;">
						<p><b><spring:message code="shdrc_analysis_zone14_1"/></b><br><br><br><br><br>
					...
					<div id="msgTopRight" style="padding-top:50px;">
						<p><b><spring:message code="shdrc_analysis_zone14_2"/></b><br><br><br><br><br>
						This Report has no data for the selected Month and Year </p>
					</div>
					</div>
				</div>
				...
				<div style="width:99.3%;">
					...
					<div id="msgBottomLeft" style="padding-top:50px;">
						<p><b><spring:message code="shdrc_analysis_zone14_3"/></b><br><br><br><br><br>
						This Report has no data for the selected Month and Year </p>
					</div>
					</div>
					...
					<div id="msgBottomRight" style="padding-top:50px;">
						<p><b><spring:message code="shdrc_analysis_zone14_6"/></b><br><br><br><br><br>
						This Report has no data for the selected Month and Year </p>
					</div>
				</div>
			</div>
	...
	var normalChartTopLeftProperties={"renderAt": 'normalChartsTopLeft', "width": '600',"height": '300',"dataFormat": 'json',"paletteColors": "#0075c2,#1aaf5d","bgColor": "#ffffff","showBorder": "0","showHoverEffect":"1","showCanvasBorder": "0","usePlotGradientColor": "0","plotBorderAlpha": "10",
	...
	var normalChartsBottomLeftProperties={"renderAt": 'normalChartsBottomLeft', "width": '600',"height": '300',"dataFormat": 'json',"startingAngle": "20","showPercentValues": "0","showPercentInTooltip": "0","enableSmartLabels": "0","enableMultiSlicing": "0","decimals": "1","showLegend": "1","theme": "fint"};
	...
	var analysisReportName1 = "HR Details for different Cadres";
	var analysisReportName2 = "Sales License details";
	var analysisReportName3 = "Comparison of Blood Bank details";
	var analysisReportName4 = "Blood Storage Centre-BlockWise";
	...
	var analysisZoneReport1Data3 = <%= request.getAttribute("analysisZoneReport1Data3") %>;
	...
	function chartsRenderOnLoad(){
		var firstChart="msline";
		var secondChart="bar2d";
		var thirdChart="doughnut2d";
		var fourthChart="msbar2d";
		
		var bloodStorageFirstSeriesData=[];
		var bloodStorageSecondSeriesData=[];
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			...
			for(i=0;i<analysisZoneReport4Data.length;i++){
				if(analysisZoneReport4Data[i].seriesName!=indicator){
					bloodStorageFirstSeriesData.push(analysisZoneReport4Data[i]);
				}
				else{
					bloodStorageSecondSeriesData.push(analysisZoneReport4Data[i]);
				}
			}
		}	
					
		if((analysisZoneReport1Data1!=null && analysisZoneReport1Data1.length>0) || (analysisZoneReport1Data2!=null && analysisZoneReport1Data2.length>0) || (analysisZoneReport1Data3!=null && analysisZoneReport1Data3.length>0)){
			document.getElementById("normalChartsTopLeft").style.display="inline";
			document.getElementById("msgTopLeft").style.display="none";						
			StaticMS3DataChart(firstChart,normalChartTopLeftProperties,analysisReportName1,analysisZoneReport1Data1,analysisZoneReport1Data2,analysisZoneReport1Data3,"Posts");
		}
		else{
		...
		if(analysisZoneReport2Data!=null && analysisZoneReport2Data.length>0){
			...
			StaticChart(secondChart,normalChartTopRightProperties,analysisReportName2,analysisZoneReport2Data,"Indicator Value","Indicator");
		}
		else{
		...
		if(analysisZoneReport3Data!=null && analysisZoneReport3Data.length>0){
			...
			StaticChart(thirdChart,normalChartsBottomLeftProperties,analysisReportName3,analysisZoneReport3Data,"Indicator Value","Blood Bank");
		}
		else{
		...
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			...
			StaticMSChart(fourthChart,multiSeriesChartProperties,analysisReportName4,bloodStorageFirstSeriesData,bloodStorageSecondSeriesData,"Blood Storage Centre");
		}
		else{
	 ...
	 function changeChartTopLeft(){
		...
		if((analysisZoneReport1Data1!=null && analysisZoneReport1Data1.length>0) || (analysisZoneReport1Data2!=null && analysisZoneReport1Data2.length>0) || (analysisZoneReport1Data3!=null && analysisZoneReport1Data3.length>0)){
			document.getElementById("normalChartsTopLeft").style.display="inline";
			document.getElementById("msgTopLeft").style.display="none";			
			StaticMS3DataChart(chartType,normalChartTopLeftProperties,analysisReportName1,analysisZoneReport1Data1,analysisZoneReport1Data2,analysisZoneReport1Data3,"Posts");
		}
	}
	...
	function changeChartTopRight(){	
		...
		if(analysisZoneReport2Data!=null && analysisZoneReport2Data.length>0){
			document.getElementById("msgTopLeft").style.display="none";
			StaticChart(chartType,normalChartTopRightProperties,analysisReportName2,analysisZoneReport2Data,"Indicator Value","Indicator");
		}
		else{
			document.getElementById("normalChartsTopRight").style.display="none";
		}
	...
	function changeChartBottomLeft(){
		...
		if(analysisZoneReport3Data!=null && analysisZoneReport3Data.length>0){
			document.getElementById("msgBottomLeft").style.display="none";
			document.getElementById("normalChartsBottomLeft").style.display="inline";
			StaticChart(ChartType,normalChartsBottomLeftProperties,analysisReportName3,analysisZoneReport3Data,"Indicator Value","Blood Bank");
		}
		else{
			document.getElementById("normalChartsBottomLeft").style.display="none";
			document.getElementById("msgBottomLeft").style.display="block";
	...
	function changeChartBottomRight(){	
		...
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			document.getElementById("msgBottomRight").style.display="none";
			document.getElementById("multiSeriesChartsBottomRight").style.display="inline";
			StaticMSChart(chartType,multiSeriesChartProperties,analysisReportName4,bloodStorageFirstSeriesData,bloodStorageSecondSeriesData,"Blood Storage Centre");
		}
		else{
			document.getElementById("multiSeriesChartsBottomRight").style.display="none";
			document.getElementById("msgBottomRight").style.display="block";
	...
	function changeYearMonth(){
		...
		$.ajax({
			type:"POST",
			url:'dcaAnalysisZoneSearchChange.do',
			'data':{
			 ...
			 success: function(result){
					...
					analysisZoneReport1Data3=data.analysisZoneReport1Data3;
