...
<body>
<div id="DMSMainDiv">
<div id="loadingLabel" class="loadingLabel">Loading please wait...</div>
...
<%-- <input type="hidden" id="selectedInd" value="${selectedIndicator}"/> --%>
</body>
<script type="text/javascript">
...
function onCategoryChange(){
 ...
 /* $("select#indicatorName").multipleSelect('setSelects', [2, 3]);
$("#indicatorName").val("Total Number of cases treated with ARV "); */
 $('select#indicatorName').multipleSelect({
 	refresh: true
 });
