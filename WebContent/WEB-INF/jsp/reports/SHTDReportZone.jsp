		...
		<input id="directorateId"  type="hidden" name="directorateId" value="<%= request.getAttribute("directorateId") %>">
	 	<div class="zonesMainDiv" style="margin-left: -9px;">		
					...
					<tr>
						...
						<td class="searchCriteria" style="padding-left:5px;">
							<select id="reportName" name="reportName" class="reportDropDown" style="width: 250px;">
								<option value="<spring:message code="shdrc_report_zone11_1"/>"><spring:message code="shdrc_report_zone11_1"/></option>
								<option value="<spring:message code="shdrc_report_zone11_2"/>"><spring:message code="shdrc_report_zone11_2"/></option>
								<option value="<spring:message code="shdrc_report_zone11_3"/>"><spring:message code="shdrc_report_zone11_3"/></option>
								<option value="<spring:message code="shdrc_report_zone11_4"/>"><spring:message code="shdrc_report_zone11_4"/></option>
							</select> 
						</td>
			...
			function changeYearMonth(){
				...
				$.ajax({
					type:"POST",
					url:'shtdReportZoneSearchChange.do',
					'data':{
