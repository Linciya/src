		...
		<input id="directorateId"  type="hidden" name="directorateId" value="<%= request.getAttribute("directorateId") %>">
	 	<div class="zonesMainDiv" style="margin-left: -9px;">		
					...
					<tr>
						...
						<td class="searchCriteria" style="padding-left:5px;">
							<select id="reportName" name="reportName" class="dropDown">
								<option value="<spring:message code="shdrc_report_zone19_1"/>"><spring:message code="shdrc_report_zone19_1"/></option>
								<option value="<spring:message code="shdrc_report_zone19_2"/>"><spring:message code="shdrc_report_zone19_2"/></option>
								<option value="<spring:message code="shdrc_report_zone19_3"/>"><spring:message code="shdrc_report_zone19_3"/></option>
								<option value="<spring:message code="shdrc_report_zone19_4"/>"><spring:message code="shdrc_report_zone19_4"/></option>
								<option value="<spring:message code="shdrc_report_zone19_5"/>"><spring:message code="shdrc_report_zone19_5"/></option>
								<option value="<spring:message code="shdrc_report_zone19_6"/>"><spring:message code="shdrc_report_zone19_6"/></option>
								<option value="<spring:message code="shdrc_report_zone19_7"/>"><spring:message code="shdrc_report_zone19_7"/></option>
								<option value="<spring:message code="shdrc_report_zone19_8"/>"><spring:message code="shdrc_report_zone19_8"/></option>
							</select> 
						</td>
			...
			function changeYearMonth(){
				...
				$.ajax({
					type:"POST",
					url:'nlepReportZoneSearchChange.do',
					'data':{
			...
			function getRowName(reportName,month,year){
				var rowName;
				if((reportName=="ULF 07 Page 1") || (reportName=="ULF 07 Page 2") || (reportName=="ULF 07 Page 1-After 2015")
						|| (reportName=="ULF 07 Page 2-After 2015") || (reportName=="ULF 07 Page 2 - RCS & Contacts Examined")){
					rowName=["Indicator"];
				}
				else if(reportName=="Drug"){
					rowName=["Year","Month","General Type","General Name"];
				}
				else if(reportName=="District Performance"){
					rowName=["District"];
				}
				else if(reportName=="District Budget"){
			...
			function getColName(reportName){
				var colName;		
				if((reportName=="ULF 07 Page 1") || (reportName=="ULF 07 Page 2")){
					colName=["Value Type","General Type"];
				}
				else if((reportName=="ULF 07 Page 1-After 2015") || (reportName=="ULF 07 Page 2-After 2015") || (reportName=="ULF 07 Page 2 - RCS & Contacts Examined")){
					colName=["Value Type","General Type","General Name"];
				}
				else if((reportName=="Drug") || (reportName=="District Performance")){
					colName=["Indicator"];
				}
				else if(reportName=="District Budget"){
					colName=["Year","Month"];
