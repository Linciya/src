...
<html>
		...
		<table>
			...
			<div style="width:99.3%;">
				...
				<div id="msgTopLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone12_1"/></b><br><br><br><br><br>
				...
				<div id="msgTopRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone12_2"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
			...
			<div style="width:99.3%;">
				...
				<div id="msgBottomLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone12_3"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
				...
				<div id="msgBottomRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone12_6"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
	...
	var analysisReportName1 = "Birth & Death (Yearly comparison)";
	var analysisReportName2 = "Death Report";
	var analysisReportName3 = "Cases Confirmed (Yearly Comparison)";
	var analysisReportName4 = "Delivery Report  (Yearly)";
	...
	function chartsRenderOnLoad(){
		...
		var birthDeathFirstSeriesData=[];
		var birthDeathSecondSeriesData=[];
		if(analysisZoneReport1Data!=null && analysisZoneReport1Data.length>0){
			var indicator=analysisZoneReport1Data[0].seriesName;
			for(i=0;i<analysisZoneReport1Data.length;i++){
				if(analysisZoneReport1Data[i].seriesName!=indicator){
					birthDeathFirstSeriesData.push(analysisZoneReport1Data[i]);
				}
				else{
					birthDeathSecondSeriesData.push(analysisZoneReport1Data[i]);
				}
			}
		}
		...
		if(analysisZoneReport1Data!=null && analysisZoneReport1Data.length>0){
			...
			StaticMSChart(firstChart,normalChartTopLeftProperties,analysisReportName1,birthDeathFirstSeriesData,birthDeathSecondSeriesData,"Month");
		}
		else{
		...
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			...
			StaticChart(fourthChart,normalChartBottomRightProperties,analysisReportName4,analysisZoneReport4Data,"Indicator Value","Indicator");
		}
		else{
	...
	function changeChartTopLeft(){
		...
		if(analysisZoneReport1Data!=null && analysisZoneReport1Data.length>0){
			document.getElementById("msgTopLeft").style.display="none";
			StaticMSChart(chartType,normalChartTopLeftProperties,analysisReportName1,birthDeathFirstSeriesData,birthDeathSecondSeriesData,"Month");
		}
		else{
			document.getElementById("normalChartsTopLeft").style.display="none";
			document.getElementById("msgTopLeft").style.display="block";
	...
	function changeChartBottomRight(){
		...
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			document.getElementById("msgBottomRight").style.display="none";
			StaticChart(chartType,normalChartBottomRightProperties,analysisReportName4,analysisZoneReport4Data,"Indicator Value","Indicator");
		}
		else{
			document.getElementById("normalChartsBottomRight").style.display="none";
			document.getElementById("msgBottomRight").style.display="block";
	...
	function changeYearMonth(){
		...
		$.ajax({
			type:"POST",
			url:'cocAnalysisZoneSearchChange.do',
			'data':{
