...
<html>
		...
		<table>
			...
			<div style="width:99.3%;">
				...
				<div id="msgTopLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone16_1"/></b><br><br><br><br><br>
				...
				<div id="msgTopRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone16_2"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
			...
			<div style="width:99.3%;">
				...
				<div id="msgBottomLeft" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone16_3"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
				...
				<div id="msgBottomRight" style="padding-top:50px;">
					<p><b><spring:message code="shdrc_analysis_zone16_6"/></b><br><br><br><br><br>
					This Report has no data for the selected Month and Year </p>
				</div>
				</div>
			</div>
	...
	var multiSeriesChartProperties={"renderAt": 'multiSeriesChartsBottomRight', "width": '600',"height": '300',"dataFormat": 'json',"startingAngle": "20","showPercentValues": "0","showPercentInTooltip": "0","enableSmartLabels": "0","enableMultiSlicing": "0","decimals": "1","showLegend": "1","theme": "fint"};
	
	var analysisReportName1 = "ACT Samples Details";
	var analysisReportName2 = "Details of Civil cases";
	var analysisReportName3 = "Details of Criminal cases";
	var analysisReportName4 = "Details of FSS ACT Samples";
	...
	var analysisZoneReport1Data4 = <%= request.getAttribute("analysisZoneReport1Data4") %>;
	...
	function chartsRenderOnLoad(){
		...
		var secondChart="doughnut2d";
		var thirdChart="bar2d";
		var fourthChart="line";	
			
		if((analysisZoneReport1Data1!=null && analysisZoneReport1Data1.length>0) || (analysisZoneReport1Data2!=null && analysisZoneReport1Data2.length>0) || (analysisZoneReport1Data3!=null && analysisZoneReport1Data3.length>0) || (analysisZoneReport1Data4!=null && analysisZoneReport1Data4.length>0)){
			document.getElementById("normalChartsTopLeft").style.display="inline";
			document.getElementById("msgTopLeft").style.display="none";
			StaticMS4DataChart(firstChart,normalChartTopLeftProperties,analysisReportName1,analysisZoneReport1Data1,analysisZoneReport1Data2,analysisZoneReport1Data3,analysisZoneReport1Data4,"District");
		}
		else{
		...
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			...
			StaticChart(fourthChart,multiSeriesChartProperties,analysisReportName4,analysisZoneReport4Data,"Indicator Value","Indicator");
		}
		else{
	...
	function changeChartTopLeft(){
		...
		if((analysisZoneReport1Data1!=null && analysisZoneReport1Data1.length>0) || (analysisZoneReport1Data2!=null && analysisZoneReport1Data2.length>0) || (analysisZoneReport1Data3!=null && analysisZoneReport1Data3.length>0) || (analysisZoneReport1Data4!=null && analysisZoneReport1Data4.length>0)){
			document.getElementById("msgTopLeft").style.display="none";
			StaticMS4DataChart(chartType,normalChartTopLeftProperties,analysisReportName1,analysisZoneReport1Data1,analysisZoneReport1Data2,analysisZoneReport1Data3,analysisZoneReport1Data4,"District");
		}
		else{
			document.getElementById("normalChartsTopLeft").style.display="none";
			document.getElementById("msgTopLeft").style.display="block";
	...
	function changeChartBottomRight(){
		...
		if(analysisZoneReport4Data!=null && analysisZoneReport4Data.length>0){
			document.getElementById("msgBottomRight").style.display="none";
			StaticChart(chartType,multiSeriesChartProperties,analysisReportName4,analysisZoneReport4Data,"Indicator Value","Indicator");
		}
		else{
			document.getElementById("multiSeriesChartsBottomRight").style.display="none";
			document.getElementById("msgBottomRight").style.display="block";
	...
	function changeYearMonth(){
		...
		$.ajax({
			type:"POST",
			url:'dfsAnalysisZoneSearchChange.do',
			'data':{
			 ...
			 success: function(result){
				 	...
				 	analysisZoneReport1Data4=data.analysisZoneReport1Data4;
