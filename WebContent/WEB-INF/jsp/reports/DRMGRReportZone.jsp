		...
		<input id="directorateId"  type="hidden" name="directorateId" value="<%= request.getAttribute("directorateId") %>">
	 	<div class="zonesMainDiv" style="margin-left: -9px;">		
			 	...
			 	<table id="searchCriteria">
					<tr>
						...
						<td class="searchCriteria" style="padding-left:5px;">
							<select id="reportName" name="reportName" class="reportDropDown" style="width:300px;">
								<option value="<spring:message code="shdrc_report_zone9_1"/>"><spring:message code="shdrc_report_zone9_1"/></option>
								<option value="<spring:message code="shdrc_report_zone9_2"/>"><spring:message code="shdrc_report_zone9_2"/></option>
								<option value="<spring:message code="shdrc_report_zone9_3"/>"><spring:message code="shdrc_report_zone9_3"/></option>								
							</select> 
						</td>
			...
			function changeYearMonth(){
				...
				$.ajax({
					type:"POST",
					url:'drmgrReportZoneSearchChange.do',
					'data':{
			...
			function getRowName(reportName,month,year){
				var rowName;
				if(reportName=="Degrees Awarded in the Convocation"){
					rowName=["Course Category","Course Name","Branch Name"];
				}
				else if (reportName=="Students Admission details (Institution wise)"){
					rowName=["Course Speciality","Course Name"];
				}
				else if ((reportName=="PHD Awarded")){
					rowName=["Branch","General Code"];
				}
				return rowName;
			}
			...
			function getColName(reportName){
				var colName;		
				if((reportName=="PHD Awarded") || (reportName=="Degrees Awarded in the Convocation")){
					colName=["Indicator"];
				}	
				else if((reportName=="Students Admission details (Institution wise)")){
					colName=["Instituion Name","Indicator"];
				}	
				return colName;
			} 
