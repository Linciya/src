...
<title>Fully Immunized Predictive Zone</title>
	...
	<table>
		...
		<div style="width:99.3%;">
			<div id="topLeft" align="center" style="width:50.5%;height:350px;float:left;border:0.1px solid black;box-shadow: 0 0 1em olive;border-radius:10px;">
				<div class="predictiveHeader" align="left">
					<input id="topLeftLabel" style="width:600px;margin-left: 10px;margin-top: 2px;border: none;background: none;" value="<spring:message code="label_immunization"/>" readonly="readonly" title="">
				</div>
			...
			<div id="topright" align="center" style="width:48.8%;height:350px;float:right;border:0.1px solid black;box-shadow: 0 0 1em olive;border-radius:10px;">
				<div class="predictiveHeader" align="left">
					<input id="topRightLabel" style="width:600px;margin-left: 10px;margin-top: 2px;border: none;background: none;" value="<spring:message code="label_fully_immunized_district_wise"/>" readonly="readonly" title="">
				</div>
		...
		<div style="width:99.3%;">
			<div id="bottomLeft" align="center" style="width:50.5%;height:350px;float:left;margin-top:4px;margin-bottom:4px;border:0.1px solid black;box-shadow: 0 0 1em olive;border-radius:10px;">
				<div class="predictiveHeader" align="left">
					<input id="bottomLeftLabel" style="width:600px;margin-left: 10px;margin-top: 2px;border: none;background: none;" value="<spring:message code="label_fully_immunized_district_trend"/>" readonly="readonly" title="">
				</div>
				<div id="LineChartsBottomLeft" style="padding-top:0px;"></div>
			...
			<div id="bottomRight" align="center" style="width:48.8%;height:350px;float:right;margin-top:4px;margin-bottom:4px;border:0.1px solid black;box-shadow: 0 0 1em olive;border-radius:10px;">
				<div class="predictiveHeader" align="left">
					<input id="bottomRightLabel" style="width:600px;margin-left: 10px;margin-top: 2px;border: none;background: none;" value="<spring:message code="label_fully_immunized_state_trend"/>" readonly="readonly" title="">
				</div>
...
var LineChartsBottomLeftProperties={"renderAt": 'LineChartsBottomLeft', "width": '600',"height": '300',"dataFormat": 'json',"startingAngle": "20","showPercentValues": "0","showPercentInTooltip": "0","enableSmartLabels": "0","enableMultiSlicing": "0","decimals": "1","showLegend": "1","theme": "fint"};
...
function onLoad(){
	var FIPTopLeftData=<%= request.getAttribute("FIPTopLeftData") %>;
	var FIPTopRightData=<%= request.getAttribute("FIPTopRightData") %>;
	var FIPBottomLeftData=<%= request.getAttribute("FIPBottomLeftData") %>;
	var FIPBottomRightData=<%= request.getAttribute("FIPBottomRightData") %>;
	
	if(FIPTopLeftData === '' || FIPTopLeftData === null){
		 $('#barTopLeft').empty();
		 $('#msgTopLeft').show();			 
  	}else{
  		$('#msgTopLeft').hide();
		...
		barChart(barTopLeftChartProperties,barChartSubCaption,FIPTopLeftData,barChartHeader);	
  	}
    if(FIPTopRightData === '' || FIPTopRightData === null){
		 $('#barTopRight').empty();
		 $('#msgTopRight').show();			 
	}else{
		$('#msgTopRight').hide();
		...
		barChart(barTopRightChartProperties,barChartSubCaption,FIPTopRightData,barChartHeader);
	}
  	if(FIPBottomLeftData === '' || FIPBottomLeftData === null){
		 $('#LineChartsBottomLeft').empty();
		 $('#msgBottomLeft').show();			 
		}
  	else{
  		$('#msgBottomLeft').hide();
  		var firstChart="line";
  		StaticChart(firstChart,LineChartsBottomLeftProperties,"",FIPBottomLeftData,"","Year");
  	}
  	if(FIPBottomRightData === '' || FIPBottomRightData === null){
 		...
 		$('#msgBottomRight').hide();
 		var firstChart="line";
  		StaticChart(firstChart,LineChartsBottomRightProperties,"",FIPBottomRightData,"","Year");
 	}
}
$(document).ready(function() {
	...
	var dist='${district}';
	$('#topLeftLabel').val($('#topLeftLabel').val()+' - '+year+' & '+dist);
   	$('#topRightLabel').val($('#topRightLabel').val()+' - '+year);
   	$('#bottomLeftLabel').val($('#bottomLeftLabel').val()+' - '+dist);
   	$('#bottomRightLabel').val($('#bottomRightLabel').val());
...
function onSearch()
{
	...
	$.ajax({
		...
		success: function(result){
			...
			var FIPTopLeftData=data.FIPTopLeftData;
			var FIPTopRightData=data.FIPTopRightData;
			var FIPBottomLeftData=data.FIPBottomLeftData;
			var FIPBottomRightData=data.FIPBottomRightData;
			var district = data.district;
		   	...
		   	$('#topLeftLabel').val(topLeftLabel+' - '+year+' & '+district);
		   	$('#topRightLabel').val(topRightLabel+' - '+year);
		   	...
		   	$('#bottomLeftLabel').prop('title',$('#bottomLeftLabel').val());
		   	$('#bottomRightLabel').prop('title',$('#bottomRightLabel').val());
			if(typeof FIPTopLeftData == 'undefined' || FIPTopLeftData.length === 0 || FIPTopLeftData === ''){
				 $('#barTopLeft').empty();
				 $('#msgTopLeft').show();	
			}else{
				$('#msgTopLeft').hide();
			...
			if(typeof FIPTopRightData == 'undefined' || FIPTopRightData.length === 0 || FIPTopRightData === ''){
				 $('#barTopRight').empty();
				 $('#msgTopRight').show();
			}else{
				$('#msgTopRight').hide();
			...
			if(typeof FIPBottomLeftData == 'undefined' || FIPBottomLeftData.length === 0 || FIPBottomLeftData === ''){
				$('#LineChartsBottomLeft').empty();
				$('#msgBottomLeft').show();
			}else{
				$('#msgBottomLeft').hide();
			...
			if(typeof FIPBottomRightData == 'undefined' || FIPBottomRightData.length === 0 || FIPBottomRightData === ''){
				$('#LineChartsBottomRight').empty();
				$('#msgBottomRight').show();
			}else{
				$('#msgBottomRight').hide();
