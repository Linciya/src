...
<html>
	...
	<body onload="onLoad();">
		...
		<form name="addGeneral" method="POST" action="GeneralMasterAddOnSubmit.do" id="addGeneral" class="form-inline">
		...
		<table>
			...
			<table align="center" border="0">
				<tr>
					<td width=1340px; height=30px; colspan="2" align="center" style="background:#C6E2FF;">
				...
				<tr>
					...
					<td style="width: 350px;padding-left: 30px;padding-top:15px;background:#E9FFDB;">
						<input type="text" id="generalCategory" name="generalCategory" size="16" title="Enter the General Category of the Indicator (Eg:HR)"/>
					</td>	
				</tr>
				<tr>
					<td align="left" class="required rowstyle" width="210px;">
				...
				<tr>
					...
					<td style="width: 350px;padding-left: 30px;padding-top:15px;background:#E9FFDB;">
						<input type="text" id="generalName" name="generalName" size="16" title="Enter the General Name (Eg:Physiotherapist,ECG Technician,Radiographer for General Type-Speciality)" />
					</td>
				</tr>				
				<tr>
					<td align="left" class="rowstyle" width="210px;">
					...
					<td style="width: 350px;padding-left: 30px;padding-top:15px;background:#E9FFDB;">
						<input type="text" id="subCategory" name="subCategory" size="16" title="Enter the General SubCategory (Eg:'HR')" />
					</td>
				</tr>
				<tr>
					<td align="left" class="rowstyle" width="210px;">
					...
					<td style="width: 350px;padding-left: 30px;padding-top:15px;background:#E9FFDB;">
						<input type="text" id="subSubCategory" name="subSubCategory" size="16" title="Enter the General SubSubCategory (Eg:'HR')" />
					</td>
				</tr>
				<tr>
					<td align="left" class="required rowstyle" width="210px;">
					...
					<td style="width: 350px;padding-left: 30px;padding-top:15px;background:#E9FFDB;">
						<input type="text" id="classification" name="classification" size="16" title="Enter the General Classification (Eg:Posts)" />
					</td>
				</tr>
				<tr>
					<td style="background:#E9FFDB;" width=300px; ></td>
					<td width=300px; style="padding-top:25px; padding-bottom:15px;background:#E9FFDB;">&nbsp;&nbsp;&nbsp;
		...
		var form = $('#addGeneral');
		   function doSubmit(){
			...
			if(formFlag){
				formFlag = confirm("Do you really want to add the General Name?");
				   if(formFlag){
					   document.getElementById('submitbtn').disabled=true; 
					   document.addGeneral.submit(); 
					
					
					/*  $.ajax({type: form.attr('method'),
							url: form.attr('action'),
							'data':  { 
								submitType:'add',directorateId:directorateId,indicatorId:indicatorId,generalCategory:generalCategory,
								type:type,otherType:otherType,generalName:generalName,subCategory:subCategory,subSubCategory:subSubCategory,
								classification:classification,CSRF_TOKEN:csrfToken},
