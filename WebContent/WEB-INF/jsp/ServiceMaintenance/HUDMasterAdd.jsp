...
<html>
	...
	<body>
		...
		<form name="addHud" method="POST" action="hudMasterServlet" id="addHud" class="form-inline">
			...
			<table border="0">
				...
				<tr>
					...
					<td style="width: 350px;padding-left: 20px;padding-top:15px;background:#E9FFDB;">
						<select id="directorateName" name="directorateName" class="dropDown" title="Select the name of the Directorate">
				...
				<tr>
					...
					<td style="width: 350px;padding-left: 20px;padding-top:15px;background:#E9FFDB;">
						<input type="text" id="hudName" name="hudName" size="16" title="Enter the HUD name" />
					</td>
				</tr>
				<tr>
					<td align="left" class="required rowstyle" width="210px;">
					...
					<td style="width: 350px;padding-left: 20px;padding-top:15px;background:#E9FFDB;">
						<input type="text" id="hudType" name="hudType" size="16" readonly="readonly" value=<%=request.getAttribute("hudType")%> title="Type of HUD" />
					</td>
				</tr>
				<tr>
					<td align="left" class="rowstyle" width="320px;">
			        	<b>HUD Group</b>
					</td>
					<td style="width: 350px;padding-left: 20px;padding-top:15px;background:#E9FFDB;">
						<input type="text" id="hudGroup" name="hudGroup" size="16" title="Enter HUD Group" />
					</td>
				</tr>
				<!-- <tr>
					...
					<td style="width: 350px;padding-left: 20px;padding-top:15px;">
						<input type="checkbox" name="active" id="active" title="Check to make the HUD Active"/>
					</td>
				</tr>  -->
				<tr>
					<td style="width:140px;background:#E9FFDB;" ></td>
					<td width=140px; style="padding-top:15px; padding-bottom:15px;background:#E9FFDB;">&nbsp;&nbsp;&nbsp;
						<button id="submit" type="button" class="btn btn-primary" title="Add new HUD" onclick="doSubmit();">Submit</button>&nbsp;&nbsp;
						<button id="close" type="button" class="btn btn-primary" title="close Add HUD page" value="Close" onclick="doClose();">Close</button>&nbsp;&nbsp;
					</td>
				</tr>
			</table>
			</div>
		...
		function doSubmit(){
			...
			if(directorateId == ""){
				alert('Please choose the Directorate Name to add the HUD');
				document.getElementById('directorateName').focus();
				return false;
			}
			if(hudName == ""){
				alert('Please enter the Name of the HUD you want to add');
			...
			if(formFlag){
				formFlag = confirm("Do you really want to add the HUD?");
				   if(formFlag){
					   document.getElementById('submit').disabled=true;
						$.ajax({type: "POST",
							url: 'HUDMasterAddOnSubmit.do',
							'data':  form.serialize(),
