...
<html>
	...
	<jsp:include page="MenuLinks.jsp"/>	
		<form name="thresholdForm" method="POST" action="IndicatorMasterDashBoardChangeOnSubmit.do" id="thresholdForm">
		...
		<div id="home" class="tab-pane fade in active" style="height: 800px;padding-top: 20px;">
			...
			<table>
				<tr >
					...
					<td width="890px;" align="right" style="background:#FFFFCC;padding-right: 70px;padding-top: 10px;">
			...
			<ul class="nav nav-tabs nav-pills" style="border: solid 3px #007297;background: #BDEDFF">
				    <li ><a data-toggle="tab" style="font-weight:bold;" href="#home">Indicator Basic Details <img src="images/indic.jpg" width="35" height="35"/></a></li>
			...
			<table border="0">	
				...
				<tr>
					<td>
						<P align="center"><mark>Example of Threshold Value based on Threshold Type Selection</mark></P>
						 <dl>
						   <dt>Numeric - 14</dt>
						    <!--  <dd>14</dd> -->
							   	...
							   	if(thresholdTableData[i]!=null){
							   		...
							   		if(typeof thresholdValue == 'undefined'){
							   			...
							   			if(!isValidDecimal(thresholdValue)){
							   				alert("Please enter upto Decimal number in '"+hierarchy+"' field");
							   				return false;
							   			}
							   		}
							   	 ...
							   	 if(formFlag){
								   		formFlag = confirm("Do you really want to change the Threshold details?");
									    if(formFlag){
