...
<html>
	...
	<jsp:include page="MenuLinks.jsp"/>	
		<form name="calculationForm" method="POST" action="IndicatorMasterCalculationAddOnSubmit.do" id="calculationForm">
	    ...
	    <div id="home" class="tab-pane fade in active" style="height: 800px;padding-top: 40px;padding-left: 40px;">
			...
			<table>
				<tr >
					...
					<td width="850px;" align="right" style="background:#FFFFCC;padding-right: 70px;padding-top: 10px;">
			...
			<table border="0">	
				...
				<tr>
					...
					<div id="formulaGrid" style="padding-left: 200px; padding-bottom: 50px;background:#E9FFDB;">
						<table>
							<tr>
								<td>
									<label id="formulalabel">Formula : <%= request.getAttribute("indicatorName") %>   =</label>&nbsp;&nbsp;
								</td>
				...
				<tr>
					<td style="background:#E9FFDB;" align="center" width="800px;">		
						<button id="displayFormula" type="button" style="background: #007297;color: white;border: 2px solid;border-radius: 10px;font-family: arial;font-weight: bold;font-size: 12pt;width: 170px;height: 40px;" onclick="showFormula();">Display Formula</button>&nbsp;
