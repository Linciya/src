...
<div style="background: #F0F6FF;width: 100%;height: 100%;" >
	 ...
	 <div style="padding-left:210px;">
		...
		<div style="padding-left:210px;">
			<table border="0">
				...
				<tr>
					<td height=50px; style="font:16px arial;font-weight:bold;">
						<b><label id="lblHierarchy1"></label></b>&nbsp;&nbsp;
					</td>
					<td>:</td>
					<td width="250px;"><div class="col-lg-5">
						<select id="hierarchyName1" name="hierarchyName1" class="dropDown"  onchange="changeHierarchyDropdown1();">
							<option  value="">--Select-- </option>
						</select></div>
					</td>
					<td  width="50px;" style="font:16px arial;font-weight:bold;">
				...
				<tr>
					<td height=50px; style="font:16px arial;font-weight:bold;">
						<b><label id="lblHierarchy2"></label></b>&nbsp;&nbsp;
					</td>
					<td>:</td>
					<td width="250px;"><div class="col-lg-5">
						<select id="hierarchyName2" class="dropDown" name="hierarchyName2" >
							<option  value="">--Select-- </option>
						</select></div>
					</td>
					<td width="50px;" style="font:16px arial;font-weight:bold;">	
				...
				<tr>
					...
					<td>:</td>
					<td colspan="5" width="250px;"><div class="col-lg-5">	
	...
	<div style="float: left; width: 20%;background: #F0F8FF;margin-left:5px;">
		...
		<div style="width: 425px; height: 682px; border:solid 2px #007297;background: #E9FFDB;border-bottom-left-radius:25px;border-bottom-right-radius: 25px; padding-top:15px;padding-right:25px;padding-bottom:25px;overflow-x: hidden;overflow-y: auto;">
			<table height="635px;">
				<tr>
					<td valign="top">
			   			<%
...
<script src="bootstrap/js/bootstrap.min.js"></script>
  ...
  function changeDirectorate(){
		 ...
		 if(directorateId==""){
			 ...
			 document.getElementById('hierarchyName1').value="";
			 document.getElementById('hierarchyName2').value="";
			 
			 $('#hierarchyName1').empty(); //remove all child nodes
	        var newOption = $('<option value="">--Select--</option>');
	        $('#hierarchyName1').append(newOption);
	        $('#hierarchyName1').trigger("chosen:updated");
			...
			var contextPath='<%=request.getContextPath()%>';
			document.location.href=contextPath+'/uploadTNMSCExcel.do';
		 }
		 else{
			 enableHierarchyDropdown(directorateId);
			 $.ajax({type: "POST",
