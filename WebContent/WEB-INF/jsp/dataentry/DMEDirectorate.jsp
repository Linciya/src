...
<table border="0">
	<tr>
		...
		<td class="directoratenameheader" width="1260px;">
			<label style="padding-left: 320px;font-size: 14px;">Directorate of Medical Education</label><br>
	...
	<tr> 
		...
		<b>Directorate</b> - <label id="gridDirectorateLabel">DME</label> <br><br>
	...
	<tr>
		...
		<td align="center" width="1260px;">		
			...
			<button id="cancel" type="button" class="btn btn-primary" value="Cancel" onclick="doCancel('<%=request.getContextPath()%>','/dmeDataEntry.do');">Reset Form</button>&nbsp;
...
<script>
	...
	function doSearch(classificationName,tabId,action){
		   ...
		   if (e1 != 'undefined') {
			...
			'data':  { 
			    ...
			    success: function (output) {
			    	...
			    	var gridData = data.dmeDirectorateRecords;
 	...
 	function changeDistrict(){
		var form = $('#dmeDirectorateForm');
		var e1 = document.getElementById("districtName");
		var districtId = e1.options[e1.selectedIndex].value;
		$.ajax({type:"POST",
			url: 'dmedistrictChange.do',
			'data':  { 
