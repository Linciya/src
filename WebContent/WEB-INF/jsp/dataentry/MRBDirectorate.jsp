...
<table>
	...
	<td align="right" class="required" width="170px;">	
		...
		<td width="170px;">	
			...
			<option value='-99'>State Level</option>
			</select> 		
		</td>	
		<td  align="right" width="170px;">
...
<table border="0">
	<tr>
		...
		<td class="directoratenameheader" width="1260px;">
			<label style="padding-left: 320px;font-size: 14px;">Medical Recruitment Board</label><br>
	...
	<tr> 
		...
		<b>Directorate</b> - <label id="gridDirectorateLabel">MRB</label> <br><br>&nbsp;
	...
	<tr>
		...
		<td align="center" width="1260px;">		
			...
			<button id="cancel" type="button" class="btn btn-primary" value="Cancel" onclick="doCancel('<%=request.getContextPath()%>','/mrbDataEntry.do');">Reset Form</button>&nbsp;
...
<script>
	   ...
	   function doSearch(classificationName,tabId,action){
		   ...
		   if (e1 != 'undefined') {
			...
			url:'mrb'+action+'.do',
			'data':  { 
				searchDate: searchDate,month: month,year: year,districtId:districtId,classificationName:classificationName,frequency:frequency,week:week,quarter:quarter
			    },
			    success: function (output) {
			    	var data = JSON.parse(output);
			    	var gridData = data.mrbDirectorateRecords;
