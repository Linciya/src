...
<table border="0">
	<tr>
		...
		<td class="directoratenameheader" width="1260px;">
			<label style="padding-left: 320px;font-size: 14px;">Tamil Nadu Medical Services Corporation</label><br>
	...
	<tr> 
		...
		<b>Directorate</b> - <label id="gridDirectorateLabel">TNMSC</label> <br><br>
		<!-- <b></b> - <label id="gridDistrictLabel"></label></br><br> -->
		<b>Warehouse</b> - <label id="gridInstitutionLabel"></label><br><br>
	...
	<tr>
		...
		<td align="center" width="1260px;">		
			...
			<button id="cancel" type="button" class="btn btn-primary" value="Cancel" onclick="doCancel('<%=request.getContextPath()%>','/tnmscDataEntry.do');">Reset Form</button>&nbsp;
		   ...
		   var classificationName;
			...
			'data':  { 
			    ...
			    success: function (output) {
			    	...
			    	var gridData = data.tnmscDirectorateRecords;
			    	//var isDataExists = data.isDataExists;
