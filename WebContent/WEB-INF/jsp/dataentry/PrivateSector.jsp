		...
		<table border="0">
			<tr>
				...
				<td class="directoratenameheader" width="1260px;">
					<label style="padding-left: 320px;font-size: 14px;">Private Sector</label><br>
			...
			<tr> 
				...
				<b>Directorate</b> - <label id="gridDirectorateLabel">Private Sector</label><br><br>&nbsp;
				<b>District</b> - <label id="gridDistrictLabel"></label><br><br>
				<label id="gridInstitutionLabel"></label>
				<b>Frequency</b> - <label id="gridFrequencyLabel"></label><br>
				</td>
			...
			<tr>
				...
				<td align="center" width="1260px;">		
					...
					<button id="cancel" type="button" class="btn btn-primary" value="Cancel" onclick="doCancel('<%=request.getContextPath()%>','/privateSectorDataEntry.do');">Reset Form</button>&nbsp;
		...
		<script>
			 ...
			 function doSearch(classificationName,tabId,action){
				   ...
				   if (e1 != 'undefined') {
					...
					$.ajax({type:"POST",
					url:'privateSector'+action+'.do',
					'data':  { 
						searchDate: searchDate,month: month,year: year,districtId:districtId,classificationName:classificationName,frequency:frequency,
						week:week,quarter:quarter
					    },
					    success: function (output) {
					    	var data = JSON.parse(output);
					    	var gridData = data.pvtSecDirectorateRecords;
			   ...
			   function doSubmit(){
				   ...
				   if(formFlag){
					   ...
					   if(formFlag){
						   ...
						   $.ajax({type:"POST",
								url:'privateSector'+submitType+'.do',
								'data':  { 
									handsOnTableData: JSON.stringify(handsOnTableData),searchDate: searchDate,month: month,year: year,districtId:districtId,
									institutionId:institutionId,classificationName:classificationName,frequency:frequency,week:week,
