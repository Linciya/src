...
<title>CMCHIS Directorate</title>
<%
	...
	<tr>
		...
		<td width="170px;">
			<select id="directorateName" name="directorateName" class="dropDown" onchange="changeDirectorate('<%=request.getContextPath()%>');">
				 ...
				 <option value=17>Chief Minister's Comprehensive Health Insurance Scheme</option>
			</select>
		</td>
...
<table border="0">
	<tr>
		...
		<td class="directoratenameheader" width="1260px;">
			<label style="padding-left: 320px;font-size: 14px;">Chief Minister's Comprehensive Health Insurance Scheme</label><br>
	...
	<tr> 
		...
		<b>Directorate</b> - <label id="gridDirectorateLabel">CMCHIS</label><br><br>
	...
	<tr>
		...
		<td align="center" width="1260px;">		
			...
			<button id="cancel" type="button" class="btn btn-primary" value="Cancel" onclick="doCancel('<%=request.getContextPath()%>','/cmchisDataEntry.do');">Reset Form</button>&nbsp;
...
<script>
		   ...
		   if (e1 != 'undefined') {
			...
			'data':  { 
			    ...
			    success: function (output) {
			    	...
			    	var gridData = data.cmchisDirectorateRecords;
 	...
 	function changeDistrict(){
		var form = $('#cmchisDirectorateForm');
		var e1 = document.getElementById("districtName");
		var districtId = e1.options[e1.selectedIndex].value;
		$.ajax({type:"POST",
			url:'cmchisdistrictChange.do',
			'data':  { 
