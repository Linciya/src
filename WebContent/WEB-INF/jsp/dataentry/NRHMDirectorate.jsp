...
<table border="0">
	<tr>
		...
		<td class="directoratenameheader" width="1260px;">
			<label style="padding-left: 320px;font-size: 14px;">National Rural Health Mission</label><br>
	...
	<tr> 
		...
		<b>Directorate</b> - <label id="gridDirectorateLabel">NRHM</label> <br><br>
	...
	<tr>
		...
		<td align="center" width="1260px;">		
			...
			<button id="cancel" type="button" class="btn btn-primary" value="Cancel" onclick="doCancel('<%=request.getContextPath()%>','/nrhmDataEntry.do');">Reset Form</button>&nbsp;
		   ...
		   if (e1 != 'undefined') {
			...
			'data':  { 
			    ...
			    success: function (output) {
			    	...
			    	var gridData = data.nrhmDirectorateRecords;
