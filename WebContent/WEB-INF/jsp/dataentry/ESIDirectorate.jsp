...
<table border="0">
	<tr>
		...
		<td class="directoratenameheader" width="1260px;">
			<label style="padding-left: 320px;font-size: 14px;">Employee State Health Insurance</label><br>
	...
	<tr> 
		...
		<b>Directorate</b> - <label id="gridDirectorateLabel">ESI</label><br><br>
	...
	<tr>
		...
		<td align="center" width="1260px;">		
			...
			<button id="cancel" type="button" class="btn btn-primary" value="Cancel" onclick="doCancel('<%=request.getContextPath()%>','/esiDataEntry.do');">Reset Form</button>&nbsp;
		   ...
		   if (e1 != 'undefined') {
			...
			'data':  { 
			    ...
			    success: function (output) {
			    	...
			    	var gridData = data.esiDirectorateRecords;
